...
If you need to start an incident, you can post in the [`#incident-management` channel](https://gitlab.slack.com/archives/CB7P5CJS1) using the `/incident declare` command - a bot will make and issue/google doc and zoom link for you.
