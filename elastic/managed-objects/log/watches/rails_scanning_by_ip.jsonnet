      ...
      slack: {
        ...
        message: {
          ...
          dynamic_attachments: {
            ...
            attachment_template: {
              title: 'ip: {{key}}',
              title_link: "https://log.gprd.gitlab.net/app/kibana#/discover?_g=()&_a=(columns:!(json.remote_ip,json.path,json.duration,json.status),filters:!(('$state':(store:appState),meta:(alias:!n,disabled:!f,index:AW5F1e45qthdGjPJueGO,key:json.remote_ip.keyword,negate:!f,type:phrase,value:'{{key}}'),query:(match:(json.remote_ip.keyword:(query:'{{key}}',type:phrase))))),index:AW5F1e45qthdGjPJueGO,interval:auto,query:(match_all:()),sort:!('@timestamp',desc))",
