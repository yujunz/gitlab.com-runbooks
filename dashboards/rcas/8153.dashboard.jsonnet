...
.addPanels(layout.grid([
  ...
  text.new(title='Total CI Minutes on Shared Runners',
  mode='markdown',
  content=|||
  ...
  text.new(title='Impact on web performance',
  mode='markdown',
  content=|||
  ...
  text.new(title='CI Runner 1m SLO',
  mode='markdown',
  content=|||
  ...
  text.new(title='Postgres Transaction Rollbacks',
  mode='markdown',
  content=|||
