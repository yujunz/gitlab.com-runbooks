...
basic.dashboard(
  ...
  layout.grid(
    [
      ...
      productCommon.pageDetail("Wiki - AsciiDoc", "Knowledge_Wiki_AsciiDoc", "https://gitlab.com/gitlab-com/create-knowledge-load-performance-tests/-/wikis/formats/asciidoc/formatted-1mb"),
      ...
      productCommon.pageDetail("Wiki - RDoc", "Knowledge_Wiki_RDoc", "https://gitlab.com/gitlab-com/create-knowledge-load-performance-tests/-/wikis/formats/rdoc/formatted-1mb"),
    ],
    startRow = 3001,
  ),
)