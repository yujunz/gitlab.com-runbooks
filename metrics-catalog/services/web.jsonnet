  ...
  components: {
    workhorse: {
      ...
      toolingLinks: [
        ...
        toolingLinks.kibana(title='Workhorse', index='workhorse', type='web', stage='$stage', slowRequestSeconds=10),
      ],
    },
    ...
    puma: {
      ...
      toolingLinks: [
        ...
        toolingLinks.kibana(title='Rails', index='rails', type='web', stage='$stage', slowRequestSeconds=10),
      ],
    },
  },
})
